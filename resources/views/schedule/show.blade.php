...
<section class="h-75vh flex items-center  justify-start flex-col">
    <div class=" bg-white p-3  rounded-2xl  my-10 w-1/2">
        ...
        <div class=" flex mt-10 justify-between">
            <button class=" bg-red-900 hover:bg-red-950 text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline rounded-full">Cancelar Cita</button>
            <button class="  bg-slate-200 hover:bg-slate-300 text-slate-900 font-bold py-2 px-4 focus:outline-none focus:shadow-outline rounded-full">Editar Cita</button>
        </div>
